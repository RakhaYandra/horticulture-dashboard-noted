...
const NewsItem = ({ source, date, title, snippet, imageUrl, gap = "8" }) => {
  ...
  return (
    <div className="mb-8">
      {" "}
      {/* Added margin-bottom for gap between news items */}
      <div
        className={`flex flex-col md:flex-row justify-between items-center gap-${gap} w-full md:w-[550px] h-auto md:h-[116px] p-4`}
      >
        {/* Content */}
        ...
        {/* Image */}
        <div
          className="w-full md:w-[100px] h-[200px] md:h-[100px] bg-cover bg-center rounded-md mt-4 md:mt-0"
          style={{
